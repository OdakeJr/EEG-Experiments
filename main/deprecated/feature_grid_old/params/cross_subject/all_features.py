# main/feature_grid/params/cross_subject/all_features.py

# ============================================================
# Cross-subject fused handcrafted-feature grid
# ============================================================
...
PREPROCESSING_PARAMS = [
    {
        ...
        "name": f"bci2a_cross_subject_all_{band_name}",
        "loader": {
            "channels": CHANNELS,
...
# No target-subject data are used for calibration/training.
...
# Feature selectors are fitted on source-subject training data only.
...
BENCHMARK_TABLES_PARAMS = {
    ...
    "tables": [
        {
            "name": "cross_subject_all_features",
            "scenario": "cross_subject",
            "setting_column": "Dataset",
            "output_name": "cross_subject_all_features_table.csv",
