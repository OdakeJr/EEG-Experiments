# main/feature_grid/params/cross_subject/signal_fe.py

# ============================================================
# Cross-subject signal-to-feature grid
# ============================================================
...
# fitted later using source-subject training data only.
...
PREPROCESSING_PARAMS = [
    {
        ...
        "name": f"bci2a_cross_subject_signal_{band_name}",
...
BENCHMARK_TABLES_PARAMS = {
    ...
    "tables": [
        {
            "name": "cross_subject_signal_fe",
            "scenario": "cross_subject",
            "setting_column": "Dataset",
            "output_name": "cross_subject_signal_fe_table.csv",
