# main/feature_grid/params/intra_subject/signal_fe.py

# ============================================================
# Intra-subject signal-to-feature grid
# ============================================================
...
# fitted later using training data only.
...
PREPROCESSING_PARAMS = [
    {
        ...
        "name": f"bci2a_intra_signal_{band_name}",
...
BENCHMARK_TABLES_PARAMS = {
    ...
    "tables": [
        {
            "name": "intra_signal_fe",
            "scenario": "intra_subject",
            "setting_column": "Dataset",
            "output_name": "intra_signal_fe_table.csv",
