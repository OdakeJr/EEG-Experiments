# main/feature_grid/params/intra_subject/preprocessing_fe.py

# ============================================================
# Intra-subject preprocessing-feature grid
# ============================================================
...
PREPROCESSING_PARAMS = [
    {
        ...
        "name": f"bci2a_intra_pre_{band_name}_{feature_name}",
        "loader": {
            "channels": CHANNELS,
...
BENCHMARK_TABLES_PARAMS = {
    ...
    "tables": [
        {
            "name": "intra_preprocessing_fe",
            "scenario": "intra_subject",
            "setting_column": "Dataset",
            "output_name": "intra_preprocessing_fe_table.csv",
