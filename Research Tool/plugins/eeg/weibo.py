...
def load_weibo2014_data(
    ...
    """
    Load Weibo2014 into the standardized intermediate EEG
    representation.
...
class Weibo2014Pipe(Pipe):
    """
    Prepare the Weibo2014 EEG dataset.

    NPZ/YAML
        -> trial extraction
        -> class/channel harmonization
    ...
    def run(
        ...
        if inputs:
            raise ValueError(
                "Weibo2014Pipe is a source pipe and "
        ...
        eeg_data = prepare_eeg_dataframe(
            ...
            # Loader already produces session_01.
            session_name=None,
